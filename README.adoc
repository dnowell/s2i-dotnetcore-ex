...
https://github.com/dnowell/s2i-dotnetcore[s2i-dotnetcore] builder
...
[source]
----
oc new-app registry.access.redhat.com/dotnet/dotnetcore-10-rhel7~https://github.com/dnowell/s2i-dotnetcore-ex#dotnetcore-1.0 --name=aspnet-app --context-dir=app
----
...
[source]
----
oc new-app registry.access.redhat.com/dotnet/dotnetcore-11-rhel7~https://github.com/dnowell/s2i-dotnetcore-ex#dotnetcore-1.1 --name=aspnet-app --context-dir=app
----
